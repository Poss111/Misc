...
void GLWidget::initializeCube() {
    ...
    vec3 normal[] = {
        // top
        vec3(normalize(vec3(1,1,1))),    // 0
        vec3(normalize(vec3(1,1,-1))),   // 1
        vec3(normalize(vec3(-1,1,-1))),  // 2
        vec3(normalize(vec3(-1,1,1))),   // 3

        // bottom
        vec3(normalize(vec3(1,-1,1))),   // 4
        vec3(normalize(vec3(-1,-1,1))),  // 5
        vec3(normalize(vec3(-1,-1,-1))), // 6
        vec3(normalize(vec3(1,-1,-1))),  // 7

        // front
        vec3(normalize(vec3(1,1,1))),    // 8
        vec3(normalize(vec3(-1,1,1))),   // 9
        vec3(normalize(vec3(-1,-1,1))),  // 10
        vec3(normalize(vec3(1,-1,1))),   // 11

        // back
        vec3(normalize(vec3(-1,-1,-1))), // 12
        vec3(normalize(vec3(-1,1,-1))),  // 13
        vec3(normalize(vec3(1,1,-1))),   // 14
        vec3(normalize(vec3(1,-1,-1))),  // 15

        // right
        vec3(normalize(vec3(1,-1,1))),   // 16
        vec3(normalize(vec3(1,-1,-1))),  // 17
        vec3(normalize(vec3(1,1,-1))),   // 18
        vec3(normalize(vec3(1,1,1))),     // 19

        // left
        vec3(normalize(vec3(-1,-1,1))),  // 20
        vec3(normalize(vec3(-1,1,1))),   // 21
        vec3(normalize(vec3(-1,1,-1))),  // 22
        vec3(normalize(vec3(-1,-1,-1))) // 23
...
void GLWidget::resizeGL(int w, int h) {
    ...
    glUniformMatrix4fv(cubeITModelMatrixLoc, 1, true, value_ptr(ITModelMatrix));
